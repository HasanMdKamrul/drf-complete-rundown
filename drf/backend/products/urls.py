...
from .views import product_detail_api_view,product_create_api_view,product_list_create_api_view,product_update_api_view,get_all_operations,product_delete_api_view,product_mixin_operations
